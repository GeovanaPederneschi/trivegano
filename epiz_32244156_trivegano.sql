...
-- Generation Time: Sep 29, 2022 at 04:15 AM
...
--
-- Database: `epiz_32244156_trivegano`
--
...
CREATE TABLE `tb_adm_fornecedor` (
  `id_adm_fornecedor` int(10) UNSIGNED NOT NULL,
  ...
  `tb_fornecedor_id_fornecedor` int(10) UNSIGNED NOT NULL,
...
INSERT INTO `tb_adm_fornecedor` (`id_adm_fornecedor`, `login_adm_fornecedor`, `senha_adm_fornecedor`, `email_adm_fornecedor`, `status_adm_fornecedor`, `tb_fornecedor_id_fornecedor`, `foto`) VALUES
(1, 'flavia', '1307', 'flavia_alimentacaoltda@gmail.com', 'ativo', 1, 'stevie.png'),
(2, 'camila', '1307', 'camila_restauranteltda@gmail.com', 'ativo', 50, ''),
(3, 'augusto', '1307', 'augusto_paesedoces@gmail.com', 'ativo', 55, NULL);
...
INSERT INTO `tb_categoria` (`id_categoria`, `descricao_categoria`, `ramo_categoria`, `imagem`) VALUES
(1, 'doce', 'receita', NULL),
(2, 'salgado', 'receita', NULL),
(3, 'pizza', 'produto', 'pizza.png'),
(4, 'refeição', 'produto', 'refeicao.png'),
(5, 'bebida', 'produto', 'bebida.png'),
(6, 'sobremesa', 'produto', 'sobremesa.png'),
(7, 'bebida', 'receita', NULL),
(8, 'burguer', 'produto', 'burguer.png'),
(9, 'entrada', 'produto', 'entrada.jpg');
...
INSERT INTO `tb_cliente` (`id_cliente`, `nome_cliente`, `dat_nasc_cliente`, `cpf_cliente`, `telefone_cliente`, `email_cliente`, `senha_cliente`, `status_cliente`, `dat_cadastro_cliente`, `usuario_cliente`) VALUES
(3, 'Joâo Silva Santos', '2005-02-13', '55527425839', '977908927', 'geovana@gmail.com', '1307', 'ativo', '2022-06-19 00:00:00', 'João'),
(9, 'ala', '2005-02-13', '12345678909', '11977908927', 'ala@gmail.com', '09876543', 'ativo', '2022-06-21 19:50:00', 'teste'),
(11, 'Claudio Costa Pederneschi', '2005-02-13', '55527375807', '11989003819', 'costa.pederneschi@gmail.com', '09876543', 'ativo', '2022-06-21 13:35:00', 'João'),
(12, 'Julia', '2005-02-13', '55527425831', '098909765', 'pederneschi@gmail.com', '09876543', 'ativo', '2022-06-22 02:40:00', 'Julia'),
(13, 'Julia', '2005-02-13', '55527425833', '098909765', 'pederneschi1@gmail.com', '12345678', 'ativo', '2022-06-22 02:48:00', 'Amanda'),
(14, 'Fernada', '2006-06-09', '55527425838', '11989003819', 'fernanda@gmail.com', '12345678', 'ativo', '2022-06-22 02:51:00', 'Nanda'),
(15, 'Natalia', '1999-04-13', '31543741836', '11989003819', 'nataliasousa@gmail.com', '12345678', 'ativo', '2022-06-22 03:14:00', 'Nat'),
(16, 'Giovana Oliveira', '1978-09-02', '56162946916', '(11) 86098379', 'giovanabarrosoliveira@jourrapide.com', 'Saipae0rooqu', 'ativo', '2022-07-14 03:11:00', 'Giovana');
...
CREATE TABLE `tb_fornecedor` (
  ...
  `endereco_fornecedor` varchar(120) DEFAULT NULL,
...
INSERT INTO `tb_fornecedor` (`id_fornecedor`, `razao_fornecedor`, `endereco_fornecedor`, `cnpj_fornecedor`, `email_fornecedor`, `telefone_fornecedor`, `site_fornecedor`, `nome_fantasia_fornecedor`, `status_fornecedor`, `logo`) VALUES
(1, 'Flávia e Thomas Alimentação Ltda', 'Céu', '99594199000190', 'qualidade@flaviaethomasalimentacaoltda.com.br', '1926769605', 'starship.html', 'Starship Restaurante', 'ativo', 'logo5.png'),
(50, 'Laís e Camila Restaurante Ltda', NULL, '57594556000170', 'financeiro@laisecamilarestauranteltda.com.br', '1138248221', 'www.laisecamilafinanceiraltda.com.br', 'Restaurante Savvy', 'ativo', 'logo5.png'),
(55, 'Alice e Augusto Pães e Doces ME', NULL, '17587120000130', 'estoque@aliceeaugustopaesedocesme.com.br', '123456788', 'www.aliceeaugustopaesedocesme.com.br', 'Flare Restaurante', 'ativo', 'logo5.png'),
(61, 'alelo', NULL, '123456789098765675', 'tccnavegano2@gmail.com', '123456788', NULL, 'Pronto', 'avaliando', 'logo5.png'),
(62, 'alelo', NULL, '123456789098765671', 'tccnavegano4@gmail.com', '123456788', NULL, 'Feito', 'avaliando', 'logo5.png'),
(63, 'LTDA', NULL, '098909890989098909', 'restaurante@gmail.com', '977908921', NULL, 'Cantinho Nordestino', 'avaliando', 'logo5.png'),
(64, 'LTDA', NULL, '098909890989098905', 'restaurante1@gmail.com', '977908921', NULL, 'Cantinho Brasileiro', 'avaliando', 'logo5.png'),
(65, 'LTDA', NULL, '098765432123456784', 'liberal@gmail.com', '11989003819', NULL, 'Bar Liberal', 'avaliando', 'logo5.png'),
(66, 'LTDA', NULL, '098765432123456787', 'liberalismo@gmail.com', '11989003819', NULL, 'Bar da Tijuca', 'avaliando', 'logo5.png');
...
CREATE TABLE `tb_guia` (
  ...
  `tb_usuario_adm_id_usuario_adm` int(10) UNSIGNED NOT NULL,
  `tb_categoria_id_categoria` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_imagem_guia` (
  `id_imagem_guia` int(10) UNSIGNED NOT NULL,
  `imagem_guia` varchar(255) NOT NULL,
  `tb_guia_id_guia` int(10) UNSIGNED NOT NULL,
  `tb_guia_tb_usuario_adm_id_usuario_adm` int(10) UNSIGNED NOT NULL,
  `tb_guia_tb_categoria_id_categoria` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_imagem_produto` (
  `id_imagem_produto` int(10) UNSIGNED NOT NULL,
  `imagem_produto` varchar(255) NOT NULL,
  `tb_produto_id_produto` int(10) UNSIGNED NOT NULL,
  `tb_produto_tb_categoria_id_categoria` int(10) UNSIGNED NOT NULL,
  `tb_produto_tb_adm_fornecedor_id_adm_fornecedor` int(10) UNSIGNED NOT NULL,
  `tb_produto_tb_adm_fornecedor_tb_fornecedor_id_fornecedor` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_imagem_produto` (`id_imagem_produto`, `imagem_produto`, `tb_produto_id_produto`, `tb_produto_tb_categoria_id_categoria`, `tb_produto_tb_adm_fornecedor_id_adm_fornecedor`, `tb_produto_tb_adm_fornecedor_tb_fornecedor_id_fornecedor`) VALUES
(1, 'popburguer.png', 1, 8, 1, 1),
(2, 'xburguer.png', 2, 8, 1, 1),
(3, 'meltburguer.png', 3, 8, 1, 1),
(4, 'xsalada.png', 4, 8, 1, 1),
(5, 'suconatural.jpg', 5, 5, 1, 1),
(6, 'cocacola.jpg', 6, 5, 1, 1),
(7, 'prato1.jfif', 1, 8, 1, 1);
...
CREATE TABLE `tb_imagem_receitas` (
  `id_imagem_receitas` int(10) UNSIGNED NOT NULL,
  `imagem_receita` varchar(255) NOT NULL,
  `tb_receitas_id_receitas` int(10) UNSIGNED NOT NULL,
  `tb_receitas_tb_usuario_adm_id_usuario_adm` int(10) UNSIGNED NOT NULL,
  `tb_receitas_tb_categoria_id_categoria` int(10) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_imagem_receitas` (`id_imagem_receitas`, `imagem_receita`, `tb_receitas_id_receitas`, `tb_receitas_tb_usuario_adm_id_usuario_adm`, `tb_receitas_tb_categoria_id_categoria`) VALUES
(1, 'trivegano/receitas/bolodefuba.jpg', 1, 2, 1),
(2, 'trivegano/receitas/focacciadetomate.jpg', 2, 2, 1),
(3, 'trivegano/receitas/wafflessemgluten.jpg', 3, 2, 1),
(4, 'trivegano/receitas/cracker.jpg', 4, 2, 2),
(5, 'trivegano/receitas/pão.jpg', 5, 3, 2),
(6, 'trivegano/receitas/tapiocadoce.jpg', 6, 3, 1),
(7, 'trivegano/receitas/miniaboboras.jpg', 7, 3, 2),
(10, 'trivegano/receitas/tofuempanado.jpg', 8, 3, 2),
(11, 'trivegano/receitas/salada.jpg', 9, 3, 10),
(12, 'trivegano/receitas/lasanhadeabobrinha.jpg', 11, 3, 2),
(18, 'trivegano/receitas/tabule.jpg\n', 10, 3, 10),
(19, 'trivegano/receitas/nhoquedeabobora.jpg', 12, 3, 2),
(20, 'trivegano/receitas/brownie_castanha.jpg', 15, 3, 1),
(21, 'trivegano/receitas/cookies_aveia.jpg', 16, 3, 1),
(22, 'trivegano/receitas/_pudim.jpg', 18, 3, 1),
(23, 'trivegano/receitas/pãodebanana.jpg', 20, 3, 1),
(25, 'trivegano/receitas/granola.jpg', 21, 3, 1),
(26, 'trivegano/receitas/strogonoffberinjela.jpg', 25, 3, 2),
(27, 'trivegano/receitas/bolinhainhame.png', 27, 3, 2),
(28, 'trivegano/receitas/esfihaespinafre.jpg', 28, 3, 2),
(29, 'trivegano/receitas/batataaomurro.jpg', 30, 3, 2),
(30, 'trivegano/receitas/pizzademandioca.jpg', 31, 3, 2),
(31, 'trivegano/receitas/doceabobora.jpg', 32, 3, 1),
(32, 'trivegano/receitas/torta_sorvete_morango.jpg', 33, 3, 1),
(33, 'trivegano/receitas/cupcakecoco.jpg', 34, 3, 1),
(34, 'trivegano/receitas/chocolatequente.jpg', 45, 2, 1),
(35, 'trivegano/receitas/coxinhadejaca.jpg', 48, 2, 2);
...
CREATE TABLE `tb_item_venda` (
  `id_item_venda` int(10) UNSIGNED NOT NULL,
  `n_item_produto` int(11) NOT NULL,
  `quant_item_produto` int(11) NOT NULL,
  `valor_item_produto` decimal(6,2) NOT NULL,
  `tb_pedido_venda_id_venda` int(10) UNSIGNED NOT NULL,
  `tb_pedido_venda_tb_cliente_id_cliente` int(10) UNSIGNED NOT NULL,
  `tb_produto_id_produto` int(10) UNSIGNED NOT NULL,
  `tb_produto_tb_categoria_id_categoria` int(10) UNSIGNED NOT NULL,
  `tb_produto_tb_adm_fornecedor_id_adm_fornecedor` int(10) UNSIGNED NOT NULL,
  `tb_produto_tb_adm_fornecedor_tb_fornecedor_id_fornecedor` int(10) UNSIGNED NOT NULL,
...
INSERT INTO `tb_pedido_venda` (`id_venda`, `valor_venda`, `data_venda`, `endereco_venda`, `condicao_venda`, `desconto_venda`, `status_venda`, `valor_frete_venda`, `empresa_entrega_venda`, `tb_cliente_id_cliente`, `id_promocao`) VALUES
(18, '18.00', '2022-09-26 01:36:00', 'pendente', 'pendente', NULL, 'processando', NULL, 'pendente', 3, NULL);
...
CREATE TABLE `tb_produto` (
  ...
  `tb_categoria_id_categoria` int(10) UNSIGNED NOT NULL,
  `tb_adm_fornecedor_id_adm_fornecedor` int(10) UNSIGNED NOT NULL,
  `tb_adm_fornecedor_tb_fornecedor_id_fornecedor` int(10) UNSIGNED NOT NULL,
...
INSERT INTO `tb_produto` (`id_produto`, `nome_produto`, `valor_compra_produto`, `descricao_produto`, `valor_venda_produto`, `status_produto`, `tb_categoria_id_categoria`, `tb_adm_fornecedor_id_adm_fornecedor`, `tb_adm_fornecedor_tb_fornecedor_id_fornecedor`, `desconto_compra`) VALUES
(1, 'Pop Burguer', '10.00', 'Simples e delicioso. Molho especial, um disco de carne 2.0 e cheddar.\n\nContém soja e glúten. Peso Aproximado: 150g.', '15.00', 'ativo', 8, 1, 1, NULL),
(2, 'X-Burguer', '14.00', 'Maionese, dois discos de carne 2.0, queijo cremoso, ketchup e mostarda.\n\nContém soja e glúten. Peso aproximado: 240g.', '18.00', 'ativo', 8, 1, 1, NULL),
(3, 'Melt Burguer', '15.00', 'Cebola chapeada no shoyu, dois discos de carne 2.0 e duas camadas de queijo cheddar.\n\nContém soja e glúten. Peso aproximado: 225g.', '17.50', 'ativo', 8, 1, 1, NULL),
(4, 'X-Salada', '17.00', 'Alface, tomate, cebola roxa, maionese, dois discos de carne 2.0, queijo cremoso, ketchup, mostarda e cheddar.', '20.00', 'ativo', 8, 1, 1, NULL),
(5, 'Suco Natural', '6.00', 'Fruta classica escolida por você.\n300ml.', '6.50', 'ativo', 5, 1, 1, NULL),
(6, 'Coca Cola', '5.00', '350ml', '5.50', 'ativo', 5, 1, 1, NULL);
...
CREATE TABLE `tb_promocao` (
  ...
  `id_adm_fornecedor` int(11) DEFAULT NULL,
...
INSERT INTO `tb_promocao` (`id_promocao`, `token_promocao`, `validade_promocao`, `valor_promocao`, `status_promocao`, `responsavel`, `id_usuario_adm`, `id_adm_fornecedor`, `id_fornecedor`, `id_produto`, `descricao`, `porcentagem_promocao`, `id_categoria`, `imagem_anuncio`) VALUES
(1, 'FIRST', '2030-12-25', '15.00', 'ativo', 'usuario_adm', 2, NULL, NULL, NULL, 'Promoção para primeira compra do cliente.', NULL, NULL, NULL),
(2, 'VERAO_ST', '2022-11-13', NULL, 'ativo', 'adm_fornecedor', NULL, 1, 1, NULL, 'Todos os hamburguers com desconto no verão.', 5, 8, NULL),
(3, 'ACIMA50', NULL, NULL, 'ativo', 'usuario_adm', 2, NULL, NULL, NULL, 'Em uma compra de mais de 50,00 reais ganhe 5% de desconto', 5, NULL, NULL),
(4, 'ACIMA4', NULL, NULL, 'ativo', 'adm_fornecedor', NULL, 1, 1, NULL, 'Comprando mais de 4 hamburguers ganhe 5% de desconto', 5, 8, NULL);
...
CREATE TABLE `tb_receitas` (
  `id_receitas` int(10) UNSIGNED NOT NULL,
  ...
  `ingredientes_receita` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tb_usuario_adm` (`id_usuario_adm`, `nome_usuario_adm`, `senha_usuario_adm`, `status_usuario_adm`, `email_usuario_adm`, `foto`) VALUES
(2, 'Geovana', '1307', 'ativo', 'geovanapederneschi@gmail.com', 'steve.png\n');
...
--
-- Indexes for table `tb_adm_fornecedor`
--
ALTER TABLE `tb_adm_fornecedor`
  ADD PRIMARY KEY (`id_adm_fornecedor`,`tb_fornecedor_id_fornecedor`),
  ADD UNIQUE KEY `email_adm_fornecedor_UNIQUE` (`email_adm_fornecedor`),
  ADD KEY `fk_tb_usuario_restaurante_tb_fornecedor1_idx` (`tb_fornecedor_id_fornecedor`);

--
-- Indexes for table `tb_cartao`
--
ALTER TABLE `tb_cartao`
  ADD PRIMARY KEY (`id_cartao`,`tb_cliente_id_cliente`),
  ADD UNIQUE KEY `numero_cartao_UNIQUE` (`numero_cartao`),
  ADD KEY `fk_tb_cartao_tb_cliente1_idx` (`tb_cliente_id_cliente`);
...
--
-- Indexes for table `tb_endereco_cliente`
--
ALTER TABLE `tb_endereco_cliente`
  ADD PRIMARY KEY (`id_endereco`,`tb_cliente_id_cliente`),
  ADD KEY `fk_tb_endereco_cliente_tb_cliente1_idx` (`tb_cliente_id_cliente`);
...
ALTER TABLE `tb_fornecedor`
  ...
  ADD UNIQUE KEY `nome_fantasia_fornecedor_UNIQUE` (`nome_fantasia_fornecedor`),
  ADD UNIQUE KEY `cnpj_fornecedor_UNIQUE` (`cnpj_fornecedor`),
  ADD UNIQUE KEY `email_fornecedor_UNIQUE` (`email_fornecedor`),
  ADD UNIQUE KEY `site_fornecedor_UNIQUE` (`site_fornecedor`);

--
-- Indexes for table `tb_frete`
--
ALTER TABLE `tb_frete`
  ADD PRIMARY KEY (`uf_frete`),
  ADD UNIQUE KEY `valor_frete_UNIQUE` (`valor_frete`);

--
-- Indexes for table `tb_guia`
--
ALTER TABLE `tb_guia`
  ADD PRIMARY KEY (`id_guia`,`tb_usuario_adm_id_usuario_adm`,`tb_categoria_id_categoria`),
  ADD KEY `fk_tb_guia_tb_usuario_adm1_idx` (`tb_usuario_adm_id_usuario_adm`),
  ADD KEY `fk_tb_guia_tb_categoria1_idx` (`tb_categoria_id_categoria`);

--
-- Indexes for table `tb_imagem_guia`
--
ALTER TABLE `tb_imagem_guia`
  ADD PRIMARY KEY (`id_imagem_guia`,`tb_guia_id_guia`,`tb_guia_tb_usuario_adm_id_usuario_adm`,`tb_guia_tb_categoria_id_categoria`),
  ADD KEY `fk_tb_imagem_guia_tb_guia1_idx` (`tb_guia_id_guia`,`tb_guia_tb_usuario_adm_id_usuario_adm`,`tb_guia_tb_categoria_id_categoria`);

--
-- Indexes for table `tb_imagem_produto`
--
ALTER TABLE `tb_imagem_produto`
  ADD PRIMARY KEY (`id_imagem_produto`,`tb_produto_id_produto`,`tb_produto_tb_categoria_id_categoria`,`tb_produto_tb_adm_fornecedor_id_adm_fornecedor`,`tb_produto_tb_adm_fornecedor_tb_fornecedor_id_fornecedor`),
  ADD KEY `fk_tb_imagem_produto_tb_produto1_idx` (`tb_produto_id_produto`,`tb_produto_tb_categoria_id_categoria`,`tb_produto_tb_adm_fornecedor_id_adm_fornecedor`,`tb_produto_tb_adm_fornecedor_tb_fornecedor_id_fornecedor`);

--
-- Indexes for table `tb_imagem_receitas`
--
ALTER TABLE `tb_imagem_receitas`
  ADD PRIMARY KEY (`id_imagem_receitas`,`tb_receitas_id_receitas`,`tb_receitas_tb_usuario_adm_id_usuario_adm`,`tb_receitas_tb_categoria_id_categoria`),
  ADD KEY `fk_tb_imagem_receitas_tb_receitas1_idx` (`tb_receitas_id_receitas`,`tb_receitas_tb_usuario_adm_id_usuario_adm`,`tb_receitas_tb_categoria_id_categoria`);

--
-- Indexes for table `tb_item_venda`
--
ALTER TABLE `tb_item_venda`
  ADD PRIMARY KEY (`id_item_venda`,`tb_pedido_venda_id_venda`,`tb_pedido_venda_tb_cliente_id_cliente`,`tb_produto_id_produto`,`tb_produto_tb_categoria_id_categoria`,`tb_produto_tb_adm_fornecedor_id_adm_fornecedor`,`tb_produto_tb_adm_fornecedor_tb_fornecedor_id_fornecedor`),
  ADD KEY `fk_tb_item_venda_tb_pedido_venda1_idx` (`tb_pedido_venda_id_venda`,`tb_pedido_venda_tb_cliente_id_cliente`),
  ADD KEY `fk_tb_item_venda_tb_produto1_idx` (`tb_produto_id_produto`,`tb_produto_tb_categoria_id_categoria`,`tb_produto_tb_adm_fornecedor_id_adm_fornecedor`,`tb_produto_tb_adm_fornecedor_tb_fornecedor_id_fornecedor`);

--
-- Indexes for table `tb_pedido_venda`
--
ALTER TABLE `tb_pedido_venda`
  ADD PRIMARY KEY (`id_venda`,`tb_cliente_id_cliente`),
  ADD KEY `fk_tb_pedido_venda_tb_cliente1_idx` (`tb_cliente_id_cliente`);

--
-- Indexes for table `tb_produto`
--
ALTER TABLE `tb_produto`
  ADD PRIMARY KEY (`id_produto`,`tb_categoria_id_categoria`,`tb_adm_fornecedor_id_adm_fornecedor`,`tb_adm_fornecedor_tb_fornecedor_id_fornecedor`),
  ADD KEY `fk_tb_produto_tb_categoria1_idx` (`tb_categoria_id_categoria`),
  ADD KEY `fk_tb_produto_tb_adm_fornecedor1_idx` (`tb_adm_fornecedor_id_adm_fornecedor`,`tb_adm_fornecedor_tb_fornecedor_id_fornecedor`);

--
-- Indexes for table `tb_promocao`
--
...
ALTER TABLE `tb_receitas`
  ADD PRIMARY KEY (`id_receitas`,`tb_usuario_adm_id_usuario_adm`,`tb_categoria_id_categoria`),
  ADD KEY `fk_tb_receitas_tb_usuario_adm1_idx` (`tb_usuario_adm_id_usuario_adm`),
  ADD KEY `fk_tb_receitas_tb_categoria1_idx` (`tb_categoria_id_categoria`);

--
-- Indexes for table `tb_usuario_adm`
--
ALTER TABLE `tb_usuario_adm`
  ADD PRIMARY KEY (`id_usuario_adm`),
  ADD UNIQUE KEY `email_usuario_adm_UNIQUE` (`email_usuario_adm`);
...
--
-- AUTO_INCREMENT for table `tb_adm_fornecedor`
--
ALTER TABLE `tb_adm_fornecedor`
  MODIFY `id_adm_fornecedor` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tb_cartao`
--
ALTER TABLE `tb_cartao`
  MODIFY `id_cartao` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `tb_endereco_cliente`
--
ALTER TABLE `tb_endereco_cliente`
...
--
ALTER TABLE `tb_fornecedor`
  MODIFY `id_fornecedor` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;

--
-- AUTO_INCREMENT for table `tb_guia`
--
ALTER TABLE `tb_guia`
  MODIFY `id_guia` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_imagem_guia`
--
ALTER TABLE `tb_imagem_guia`
  MODIFY `id_imagem_guia` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tb_imagem_produto`
--
ALTER TABLE `tb_imagem_produto`
  MODIFY `id_imagem_produto` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tb_imagem_receitas`
--
ALTER TABLE `tb_imagem_receitas`
  MODIFY `id_imagem_receitas` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `tb_item_venda`
--
ALTER TABLE `tb_item_venda`
  MODIFY `id_item_venda` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `tb_pedido_venda`
--
ALTER TABLE `tb_pedido_venda`
  MODIFY `id_venda` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
-- AUTO_INCREMENT for table `tb_promocao`
--
ALTER TABLE `tb_promocao`
  MODIFY `id_promocao` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tb_receitas`
--
ALTER TABLE `tb_receitas`
  MODIFY `id_receitas` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;

--
-- AUTO_INCREMENT for table `tb_usuario_adm`
--
ALTER TABLE `tb_usuario_adm`
  MODIFY `id_usuario_adm` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- Constraints for table `tb_adm_fornecedor`
--
ALTER TABLE `tb_adm_fornecedor`
  ADD CONSTRAINT `fk_tb_usuario_restaurante_tb_fornecedor1` FOREIGN KEY (`tb_fornecedor_id_fornecedor`) REFERENCES `tb_fornecedor` (`id_fornecedor`);

--
-- Constraints for table `tb_cartao`
--
ALTER TABLE `tb_cartao`
  ADD CONSTRAINT `fk_tb_cartao_tb_cliente1` FOREIGN KEY (`tb_cliente_id_cliente`) REFERENCES `tb_cliente` (`id_cliente`);

--
-- Constraints for table `tb_guia`
--
ALTER TABLE `tb_guia`
  ADD CONSTRAINT `fk_tb_guia_tb_categoria1` FOREIGN KEY (`tb_categoria_id_categoria`) REFERENCES `tb_categoria` (`id_categoria`),
  ADD CONSTRAINT `fk_tb_guia_tb_usuario_adm1` FOREIGN KEY (`tb_usuario_adm_id_usuario_adm`) REFERENCES `tb_usuario_adm` (`id_usuario_adm`);

--
-- Constraints for table `tb_imagem_guia`
--
ALTER TABLE `tb_imagem_guia`
  ADD CONSTRAINT `fk_tb_imagem_guia_tb_guia1` FOREIGN KEY (`tb_guia_id_guia`,`tb_guia_tb_usuario_adm_id_usuario_adm`,`tb_guia_tb_categoria_id_categoria`) REFERENCES `tb_guia` (`id_guia`, `tb_usuario_adm_id_usuario_adm`, `tb_categoria_id_categoria`);

--
-- Constraints for table `tb_imagem_produto`
--
ALTER TABLE `tb_imagem_produto`
  ADD CONSTRAINT `fk_tb_imagem_produto_tb_produto1` FOREIGN KEY (`tb_produto_id_produto`,`tb_produto_tb_categoria_id_categoria`,`tb_produto_tb_adm_fornecedor_id_adm_fornecedor`,`tb_produto_tb_adm_fornecedor_tb_fornecedor_id_fornecedor`) REFERENCES `tb_produto` (`id_produto`, `tb_categoria_id_categoria`, `tb_adm_fornecedor_id_adm_fornecedor`, `tb_adm_fornecedor_tb_fornecedor_id_fornecedor`);

--
-- Constraints for table `tb_imagem_receitas`
--
ALTER TABLE `tb_imagem_receitas`
  ADD CONSTRAINT `fk_tb_imagem_receitas_tb_receitas1` FOREIGN KEY (`tb_receitas_id_receitas`,`tb_receitas_tb_usuario_adm_id_usuario_adm`,`tb_receitas_tb_categoria_id_categoria`) REFERENCES `tb_receitas` (`id_receitas`, `tb_usuario_adm_id_usuario_adm`, `tb_categoria_id_categoria`);

--
-- Constraints for table `tb_item_venda`
--
ALTER TABLE `tb_item_venda`
  ADD CONSTRAINT `fk_tb_item_venda_tb_pedido_venda1` FOREIGN KEY (`tb_pedido_venda_id_venda`,`tb_pedido_venda_tb_cliente_id_cliente`) REFERENCES `tb_pedido_venda` (`id_venda`, `tb_cliente_id_cliente`),
  ADD CONSTRAINT `fk_tb_item_venda_tb_produto1` FOREIGN KEY (`tb_produto_id_produto`,`tb_produto_tb_categoria_id_categoria`,`tb_produto_tb_adm_fornecedor_id_adm_fornecedor`,`tb_produto_tb_adm_fornecedor_tb_fornecedor_id_fornecedor`) REFERENCES `tb_produto` (`id_produto`, `tb_categoria_id_categoria`, `tb_adm_fornecedor_id_adm_fornecedor`, `tb_adm_fornecedor_tb_fornecedor_id_fornecedor`);

--
-- Constraints for table `tb_pedido_venda`
--
ALTER TABLE `tb_pedido_venda`
  ADD CONSTRAINT `fk_tb_pedido_venda_tb_cliente1` FOREIGN KEY (`tb_cliente_id_cliente`) REFERENCES `tb_cliente` (`id_cliente`);

--
-- Constraints for table `tb_produto`
--
ALTER TABLE `tb_produto`
  ADD CONSTRAINT `fk_tb_produto_tb_adm_fornecedor1` FOREIGN KEY (`tb_adm_fornecedor_id_adm_fornecedor`,`tb_adm_fornecedor_tb_fornecedor_id_fornecedor`) REFERENCES `tb_adm_fornecedor` (`id_adm_fornecedor`, `tb_fornecedor_id_fornecedor`),
  ADD CONSTRAINT `fk_tb_produto_tb_categoria1` FOREIGN KEY (`tb_categoria_id_categoria`) REFERENCES `tb_categoria` (`id_categoria`);
COMMIT;
