...
INSERT INTO `tb_categoria` VALUES (1,'doce','receita',NULL),(2,'salgado','receita',NULL),(3,'pizza','produto','pizza.png'),(4,'refeição','produto','refeicao.png'),(5,'bebida','produto','bebida.png'),(6,'sobremesa','produto','sobremesa.png'),(7,'bebida','receita',NULL),(8,'burguer','produto','burguer.png'),(9,'entrada','produto','entrada.jpg');
...
INSERT INTO `tb_endereco_cliente` VALUES (1,'09853330','Alameda das Glicínias','São Bernardo do Campo','Alvarenga','SP',NULL,79,3),(2,'09894240','Praça João Caetano','São Bernardo do Campo','Jordanópolis','SP',NULL,90,9),(4,'09784290','Rua Frei Damião','São Bernardo do Campo','Montanhão','SP',NULL,678,11),(5,'09812601','Rua Cristiano Angeli','São Bernardo do Campo','Assunção','SP',NULL,467,12),(14,'09930510','Rua Mamanguape','Diadema','Campanário','SP',NULL,65,13),(15,'09952388','Passagem A Vida da Gente','Diadema','Vila Nogueira','SP',NULL,35,14),(16,'09913190','Rua Tenente Oscar Nunes','Diadema','Centro','SP',NULL,578,15),(17,'09980800','Rua Charles Chaplin','Diadema','Serraria','SP',NULL,987,16);
...
INSERT INTO `tb_imagem_produto` VALUES (1,'popburguer.png',1,8,1,1),(2,'xburguer.png',2,8,1,1),(3,'meltburguer.png',3,8,1,1),(4,'xsalada.png',4,8,1,1),(5,'suco_natural.jpg',5,5,1,1),(6,'coca_cola.jpg',6,5,1,1),(8,'refeicao7.png',7,4,2,50),(9,'refeicao8.png',8,4,2,50),(10,'refeicao9.png',9,4,2,50),(11,'refeicao10.png',10,4,2,50),(12,'refeicao11.png',11,4,2,50),(13,'refeicao12.png',12,4,2,50);
...
CREATE TABLE `tb_item_venda` (
  ...
  `tb_promocao_id_promocao` int unsigned NOT NULL,
  `tb_produtos_adicionais_id_adicional` int unsigned NOT NULL,
  PRIMARY KEY (`id_item_venda`,`tb_pedido_venda_id_venda`,`tb_pedido_venda_tb_cliente_id_cliente`,`tb_produto_id_produto`,`tb_produto_tb_categoria_id_categoria`,`tb_produto_tb_adm_fornecedor_id_adm_fornecedor`,`tb_produto_tb_adm_fornecedor_tb_fornecedor_id_fornecedor`,`tb_promocao_id_promocao`,`tb_produtos_adicionais_id_adicional`),
  UNIQUE KEY `tb_promocao_id_promocao_UNIQUE` (`tb_promocao_id_promocao`),
  UNIQUE KEY `tb_produtos_adicionais_id_adicional_UNIQUE` (`tb_produtos_adicionais_id_adicional`),
...
CREATE TABLE `tb_pedido_venda` (
  ...
  `tb_cliente_id_cliente` int unsigned NOT NULL,
  `tb_promocao_id_promocao` int unsigned NOT NULL,
  PRIMARY KEY (`id_venda`,`tb_cliente_id_cliente`,`tb_promocao_id_promocao`),
  UNIQUE KEY `tb_promocao_id_promocao_UNIQUE` (`tb_promocao_id_promocao`),
...
INSERT INTO `tb_pedido_venda` VALUES (18,18.00,'2022-09-26 01:36:00','pendente','pendente',NULL,'processando',NULL,'pendente',3,0);
...
INSERT INTO `tb_produtos_adicionais` VALUES (1,'Picles',0.00,'ativo',2,8,1,1,'picles.jpg'),(2,'Hamburguer de Soja',5.00,'ativo',2,8,1,1,'burguersoja.png');
...
-- Dump completed on 2022-10-18  7:49:59
